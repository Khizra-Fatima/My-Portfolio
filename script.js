  ...
  hexagon.addEventListener('click', function () {
    ...
    const skillDetails = {
      drf: {
        ...
        description: 'Built robust RESTful APIs with DRF, focusing on efficient data handling.'
      },

      databases: {
        title: 'Databases (PostgreSQL, MySQL, SQLite)',
        description: 'Practiced PostgreSQL and MySQL, and used SQLite in real projects for development and testing; familiar with CRUD, joins, and indexing etc.'
      },
      ...
      auth: {
        ...
        description: 'Implemented secure login systems including role-specific access.'
      },
      ...
      github: {
        title: 'GitHub',
        description: 'Utilized GitHub for code hosting and personal project repositories.'
      },
...
document.querySelectorAll('.project-card').forEach(card => {
  card.addEventListener('click', function () {
        ...
        features: [
          ...
          },
          {
            ...
            items: [
              ...
              "Edit/delete reviews.",
              "Reviews are shown on product detail pages and seller/customer dashboards."
            ]
          },
          {
    ...
    const project = projectDetails[projectID]; // Get the current project 
    ...
    projectDetail.innerHTML = `
      ...
      <a href="${project.livedemolink}" class="livedemo-link">Live Demo</a>
    `;
